...
import  {ListItemIcon as ListItemIconMaterialUI, ListItemText } from '@material-ui/core';
...
const MenuLargeWidth = ({ history,open }) => {
    ...
    return (
        <LinksConteiner>
            ...
            {open ? (
                <>
                    <div style={{ position: 'absolute', transform: 'translate(-104%, 30%)', padding: '0px', margin: '0px' }}>
